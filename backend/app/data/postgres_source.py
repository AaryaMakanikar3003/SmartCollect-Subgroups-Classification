...
#     # ---- contract method 3 ----
#     def get_conversations(self, campaign_id: int, from_date, to_date) -> list[dict]:
#         query = """
...
#                 # normalize so "Neutral" / "neutral" / " Neutral " don't get
#                 # silently treated as different categories downstream
...
#         """
#         Conversation_json is a jsonb column holding a DICT (not a bare list),
#         shaped like:
#             {
#               "eoc": 0,
#               "conversation": [
#                   {"name": "Nidhi", "sender": "Bot", "message": "...", ...},
#                   {"url": "https://..."},   <- recording links, no sender/message
#                   ...
#               ],
#               "final_response": "...",
#               "last_response_type": "..."
#             }
#         The actual turns live inside the "conversation" key.
#         psycopg2 usually gives this back already parsed as a Python dict,
#         but handle the string case too just in case.
#         """
#         if raw_json is None:
#             return ""
...
#             if not message:
#                 continue  # skips recording-link entries like {"url": "..."}
